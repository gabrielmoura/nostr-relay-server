...
// https://en.wikipedia.org/wiki/List_of_file_signatures e https://developer.mozilla.org/pt-BR/docs/Web/HTTP/MIME_types
...
var Types = []FileType{
...

	{
		...
		Extension:   "", //none, .axf, .bin, .elf, .o, .out, .prx, .puff, .ko, .mod, .so
		MIME:        "application/x-elf",
	},
	{
		Magic:       []byte{0x55, 0x50, 0x58, 0x21},
		Offset:      221,
		Extension:   "",
		Description: "UPX compressed file",
		MIME:        "",
	},
	{
	...
	//
	{
		...
		children: []FileType{{
			Magic:     []byte{0x77, 0x65, 0x62, 0x6D},
			Offset:    31,
			Extension: "webm",
			MIME:      "video/webm",
		}},
	...
	{
		Magic:       []byte{0x66, 0x74, 0x79, 0x70},
		Offset:      4,
	...
	},
	{
		...
		MIME:        "text/html",
		Extension:   "html",
		Magic:       []byte{0x3C, 0x21, 0x44, 0x4F, 0x43, 0x54, 0x59, 0x50, 0x45}, // "<!DOCTYPE"
		Offset:      0,
	},
	{
	...
	},
	{
		...
		MIME:        "audio/aac",
		Extension:   "aac",
		Magic:       []byte{0xFF, 0xF1},
		Offset:      0,
		children: []FileType{
			{
				Description: "AAC ADTS Audio",
				MIME:        "audio/aac",
				Extension:   ".aac",
				Magic:       []byte{0xFF, 0xF9},
				Offset:      0,
			},
		},
	},
	{
		Description: "MOBI eBook",
		MIME:        "application/x-mobipocket-ebook",
		Extension:   "mobi",
		Magic:       []byte{0xE9, 0x8E, 0x03, 0x00}, // MOBI-specific header
		Offset:      60,                             // Magic number starts at offset 60
	},
	{
		Magic:       []byte{0x65, 0x70, 0x75, 0x62}, // epub
		Offset:      50,
