...
func handleJobRequest(ws *dto.WsServer, evt *nostr.Event) string {
	if evt.Kind == nostr_custom.KindContentDiscovery {
		list, _ := handleJobContentDiscovery(evt.Tags)
		var respTags nostr.Tags

		for _, v := range list {
			respTags = append(respTags, nostr.Tag{"e", v})
		}
...
func handleJobContentDiscovery(tags nostr.Tags) ([]string, error) {
	...
	//],"content":"",
	//"sig":"e074820d4bedaa491b23c668b27db69d787ce00c767c9e5489fd81012c983d6b01defa3a6287076c8ebbccdcc2e8f9ea8eae7fd54991c68858e488d0ab5f3214"}

	// TODO: Implementar a lógica de descoberta de conteúdo, retornando uma lista de ids de eventos
	// TODO: Filtrar por parametros vindos da tag "param" e retornar uma lista de IDs de eventos

	list := []string{
		"545af0f74d77e6bc26b9b62a3c889daeff1f387f8a913fbcdee231a08491ee6f", // Exemplo de resposta, id do evento
	}
	return list, nil
}
